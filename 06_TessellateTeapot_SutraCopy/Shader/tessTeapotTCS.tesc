...
void main()
{
	if (gl_InvocationID == 0)
	{
		...
		gl_TessLevelInner[0] = tessInnerLevel; // TODO:–{‚Å‚ÍtessOuterLevel‚É‚È‚Á‚Ä‚¢‚é‚ª‘½•ªŠÔˆá‚¢
		gl_TessLevelInner[1] = tessInnerLevel; // TODO:–{‚Å‚ÍtessOuterLevel‚É‚È‚Á‚Ä‚¢‚é‚ª‘½•ªŠÔˆá‚¢
	}
